...
class AppColor {
  ...
  static Color primarySoft = Color(0xFFFB8C00);
  ...
  static LinearGradient bottomShadow = LinearGradient(colors: [Color(0xFFFB8C00).withOpacity(0.2), Color(0xFFFB8C00).withOpacity(0)], begin: Alignment.bottomCenter, end: Alignment.topCenter);
